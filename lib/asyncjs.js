...
(function(name, context) {
    ...
    function AsyncQueue(tasks, fn) {
        ...
        self.resolve = factory(resolve, self);
        self.reject = factory(reject, self);
    ...
    AsyncQueue.prototype.add = function(tasks, handle) {
        ...
        var i = 0, fn,
            resolver = {
                resolve: factory(resolve, self, handle),
                reject: self.reject,
                async: !!handle
            };
     ...
     */
    AsyncQueue.prototype.then = function(task) {
        var self = this;
        ...
        addSync.untilThen = true;

        return self.whenDone(addSync);
    };
